...
class _CreateLeadState extends State<CreateLead> {
  ...
  final GlobalKey<FormState> _leadFormKey = GlobalKey<FormState>();
  ...
  Widget buildLeadBlock() {
    return SwipeDetector(
      onSwipeLeft: (offset) {
        setState(() {
          if (_leadFormKey.currentState != null)
                        ...
                        child: Column(
                            ...
                            children: [
                              ...
                              Container(
                                width: screenWidth * 0.92,
                                child: TextFormField(
                                  initialValue: leadBloc
                                      .currentEditLead['opportunity_amount'],
                                  decoration: new InputDecoration(
                                    contentPadding: new EdgeInsets.symmetric(
                                        vertical: 15.0, horizontal: 10.0),
                                    enabledBorder: buildBorder(Colors.black54),
                        ...
                        child: Column(
                            ...
                            children: [
                              ...
                              Container(
                                ...
                                child: TextFormField(
                                  initialValue:
                                      leadBloc.currentEditLead['skype_ID'],
                                  decoration: new InputDecoration(
                                    contentPadding: new EdgeInsets.symmetric(
                                        vertical: 15.0, horizontal: 10.0),
                                    enabledBorder: buildBorder(Colors.black54),
                        ...
                        child: Column(
                            ...
                            children: [
                              ...
                              Container(
                                ...
                                child: TextFormField(
                                  initialValue:
                                      leadBloc.currentEditLead['email'],
                                  decoration: new InputDecoration(
                                    contentPadding: new EdgeInsets.symmetric(
                                        vertical: 15.0, horizontal: 10.0),
                                    enabledBorder: buildBorder(Colors.black54),
                    ...
                    child: Column(
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: TextFormField(
                              initialValue:
                                  leadBloc.currentEditLead['address_line'],
                              decoration: new InputDecoration(
                                contentPadding: new EdgeInsets.symmetric(
                                    vertical: 15.0, horizontal: 10.0),
                                enabledBorder: buildBorder(Colors.black54),
                    ...
                    child: Column(
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: TextFormField(
                              initialValue:
                                  leadBloc.currentEditLead['postcode'],
                              decoration: new InputDecoration(
                                contentPadding: new EdgeInsets.symmetric(
                                    vertical: 15.0, horizontal: 10.0),
                                enabledBorder: buildBorder(Colors.black54),
                        ...
                        decoration: !_isLoading
                            ? BoxDecoration(
                                border: Border(
                                    bottom: BorderSide(
                                color: Colors.white,
                                width: _currentTabIndex == 3 ? 3.0 : 0.0,
                              )))
                            : BoxDecoration(),
      ...
      if (_contactFormKey.currentState != null) {
        ...
        if (_addressFormKey.currentState != null) {
          ...
          if (leadBloc.currentEditLeadId != null &&
            ...
            _result = await leadBloc.createLead(file: file);
          }
          setState(() {
            _isLoading = false;
          });
